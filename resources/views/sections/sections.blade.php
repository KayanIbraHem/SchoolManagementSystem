...
<div class="row">
                                                        ...
                                                        <tbody>
                                                            @foreach ($grade->sections as $section)
                                                                ...
                                                                <div class="modal fade"
                                                                    id="editsection{{ $section->id }}" tabindex="-1"
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form
                                                                                    action="{{ route('sections.update', 'id') }}"
                                                                                    method="POST">
                                                                                    @method('patch')
                                                                                    @csrf
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col">
                                                                                            <label for="name_s_ar"
                                                                                                class="mr-sm-2">{{ trans('sections.section_ar') }}:</label>
                                                                                            <input type="text"
                                                                                                id="namear"
                                                                                                name="name_s_ar"
                                                                                        ...
                                                                                        <div class="col">
                                                                                            <label for="name_s_ar"
                                                                                                class="mr-sm-2">{{ trans('sections.section_en') }}:</label>
                                                                                            <input type="text"
                                                                                                id="nameen"
                                                                                                name="name_s_en"
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            for="exampleFormControlTextarea1">{{ trans('classes.select_grade') }}:</label>
                                                                                        <select
                                                                                            ...
                                                                                            @foreach ($gradeList as $grade)
                                                                                                <option
                                                                                                    value="{{ $grade->id }}"
                                                                                                    {{ $grade->id == $section->grade->id ? 'selected' : '' }}>
                                                                                                    {{ $grade->name }}
                                                                                                </option>
                                                                                            @endforeach
                                                                                        </select>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            for="exampleFormControlTextarea1">{{ trans('sections.select_class') }}:</label>
                                                                                        <select
                                                                                            class="form-control form-control-lg"
                                                                                            name="class_id">
                                                                                            <option
                                                                                                value="{{ $section->classgrade->id }}">
                                                                                                {{ $section->classgrade->name }}
                                                                                            </option>
                                                                                        </select>
                                                                                    </div>
                                                                                    <div class="col">
                                                                                    ...
                                                                                    <div class="col">
                                                                                        <label for="inputName"
                                                                                            class="control-label">{{ trans('sections.teacher_select') }}</label>
                                                                                        <select multiple
                                                                                            name="teacher_id[]"
                                                                                            class="form-control"
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button type="submit"
                                                                                    class="btn btn-success">{{ trans('schoolgrade.submit') }}</button>
                                                                            </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('sections.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col">
                                <input type="text" name="name_s_ar" class="form-control"
                                    placeholder="{{ trans('sections.section_ar') }}">
                            </div>
                            <div class="col">
                                <input type="text" name="name_s_en" class="form-control"
                                    placeholder="{{ trans('sections.section_en') }}">
                            </div>
                        </div>
                        <br>
                        <div class="col">
    ...
    <!--END ADD-->
    <!-- DELETE -->
    <div class="modal fade" id="deletesection" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
