        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('delete_attachment')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('students.confirm_attachment_deletion')}}</h5>
                    <input type="text" name="filename" readonly value="{{$attachment->name}}" class="form-control">
