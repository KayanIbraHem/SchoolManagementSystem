            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('students.store') }}" autocomplete="off"
                    ...
                    <h6 style="font-family: 'Cairo', sans-serif;color: blue">
                        {{ trans('students.personal_information') }}</h6><br>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="datepicker-action" name="dateOfBirth"
                    ...
                    <h6 style="font-family: 'Cairo', sans-serif;color: blue">{{ trans('students.study_information') }}
                    </h6><br>
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="Classroom_id">{{ trans('students.class_grade') }} : <span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="academic_year">{{ trans('students.attachment') }} : <span
                                    class="text-danger">*</span></label>
            ...
            if (grade_id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('select[name="classgrade_id"]').append(
                            '<option selected disabled>  {{ trans('students.select_class') }}...</option>'
                            );
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('select[name="section_id"]').append(
                            '<option selected disabled>  {{ trans('students.select_section') }}...</option>'
                            );
                        $.each(data, function(key, value) {
                            $('select[name="section_id"]').append(
                                '<option value="' + key + '">' + value +
